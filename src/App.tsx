...
import { Line, Content, FullScreenTheme } from './theme';
...
function App() {
  ...
  useEffect(() => {
    // if (window.location.pathname === '/nft-sale') {
  ...
  // console.log('matchPath 1', window.location.pathname === '/nft-sale');
  // ---
    ...
    <>
      ...
      >
        ...
        {window.location.pathname === '/nft-sale' && (
          <FullScreenTheme className="FullScreen">
            <MyNFTContent />
          </FullScreenTheme>
        )}
      </SaleNFTContext.Provider>
